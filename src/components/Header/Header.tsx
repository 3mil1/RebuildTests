...
export const Nav = React.memo(function () {
  ...
  return (
    <div className={classes.nav}>
      <NavLink exact activeClassName={classes.selected} to="/">
        Avaleht
      </NavLink>
      ...
      {isAuth ? (
        <NavLink activeClassName={classes.selected} to="/posts">
          Otsi
        </NavLink>
      ) : (
        false
      ...
      {isAuth ? (
        <NavLink activeClassName={classes.selected} to="/add">
          Lisa Kuulutus
        </NavLink>
      ) : (
        false
      ...
      {isAuth ? (
        ...
        <NavLink activeClassName={classes.selected} to="/register">
          Registreeri
        </NavLink>
      )}
      {isAuth ? (
        ...
        <NavLink activeClassName={classes.selected} to="/login">
          Log in
        </NavLink>
      )}
    </div>
