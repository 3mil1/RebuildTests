...
export const Post = React.memo(function (props: any) {
  ...
  const editing = () => {
    ...
    const filtered = tags.filter(
      (a: { id: number }) => !categories.map((b) => b.id).includes(a.id)
    );
      ...
      {props.canEdit ? (
        canEdit ? (
          <Tooltip title="Salvesta">
            <IconButton onClick={submit} type={"button"} form="submit-form">
              <DoneIcon />
            </IconButton>
          </Tooltip>
        ) : (
            ...
            <Controller
              ...
              as={
                <TextField
                  id="title"
                  helperText={
                    fieldsErrors.title ? fieldsErrors.title.message : ""
                  }
                  variant="outlined"
                  label="Pealkiri"
              ...
              <Controller
                ...
                as={
                  <TextField
                    id="content"
                    helperText={
                      fieldsErrors.content ? fieldsErrors.content.message : ""
                    }
                    variant="outlined"
                    label="Sisu"
