              ...
              <Grid container spacing={3} className={classes.profileContainer}>
                <Grid item xs={2}>
                  <Avatar className={classes.profileImg} variant="rounded">
                    <h3>
                      {loggedUserData.firstName[0] + loggedUserData.lastName}
                    </h3>
                  </Avatar>
                </Grid>
                <Grid item xs={9}>
                  ...
                  <div>
                    Lühi kirjeldus Lorem ipsum dolor sit amet, consectetur
                    adipisicing elit. Autem beatae consectetur deleniti dicta
                  </div>
                ...
                <Grid item xs={11}>
                  ...
                  libero, quod? At corporis ducimus esse maiores odit officia,
                  quidem. Assumenda consequatur dolorum error fugit hic labore
                  minima quibusdam soluta voluptate!
                </Grid>
              </Grid>
            </Paper>
